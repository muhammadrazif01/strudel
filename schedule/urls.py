...
from .views import mainpage, create_timeslot, show_timeslot, delete_timeslot, update_timeslot
...
urlpatterns = [
    ...
    path('update-timeslot/<int:id>', update_timeslot, name='update_timeslot'),
]
